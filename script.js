...
function calculateTip(){
    ...
    document.getElementById("tip-amount").textContent = `\R$ ${totalTip}`;
    document.getElementById("total-amount").textContent = `\R$ ${total}`;

    document.getElementById("tip-percent").textContent = `${tipPercent}%`;
    document.getElementById("split-num").textContent = noOfPeople;

    document.getElementById("tip-per-person").textContent = `\R$ ${tipPerPerson}`;
    document.getElementById("total-per-person").textContent = `\R$ ${totalPerPerson}`;
